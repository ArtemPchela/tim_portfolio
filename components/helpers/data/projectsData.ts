...
export const projectsData: ProjectProps[] = [
  ...
  },
  {
    ...
    title: 'SCB React API',
    description:
      'Smaller SCB-React-API version of the original SCB (Statistiska centralbyrn). There is a wealth of knowledge nearby regarding what you require: "Democracy", "Culture and leisure", "Research and education" and more.',
  ...
  },
  {
    ...
    description:
      'Npm package theme toggle created with Rollup.js and React. Zero dependency',
    ...
    pic: '/projects/darkMode.jpg',
    category: 'npm',
  },
  {
    id: 4,
    title: 'Personal Portfolio',
    description: 'Website about me, my skills, projects and contacts.',
    technologies: ['React', 'Next', 'TypeScript'],
    github: 'https://github.com/ArtemPchela/tim_portfolio',
    demo: 'https://artempchelenkov.online/',
    pic: '/projects/personal.jpg',
    category: 'next',
  },
]
